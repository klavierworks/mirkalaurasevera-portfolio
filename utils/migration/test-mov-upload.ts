// Self-contained upload test using ./vimeo-videos/test.mov.
// No imports from other migration files. Tries direct PUT first, then TUS.
// Reports each Bunny GUID so you can verify in the CMS.
...
const FILE_PATH = "./vimeo-videos/test.mov";
const FILE_MIME = "video/quicktime";
